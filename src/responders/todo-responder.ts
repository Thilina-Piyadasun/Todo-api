...
export namespace TodoResponder {
    ...
    export async function load(req: any, res: any): Promise<any> {
        ...
        try {
            ...
            console.error(`[todo-responder save] Error while loading data  from DB`, e);
    ...
    export async function deleteTodo(req: any, res: any): Promise<any> {
        ...
        try {
            ...
            console.error(`[todo-responder save] Error while deleting id ${todo_item_id} from DB`, e);
    ...
    export async function updateTodoState(req: any, res: any) {
        ...
        try{
            ...
            console.error(`[todo-responder save] Error while updating id ${todo_item_id} from DB`, e);
